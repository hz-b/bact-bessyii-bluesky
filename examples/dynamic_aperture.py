...
from bact_bessyii_bluesky.plans.reinjection_diagnostic_kicker_disabled import setup_reinjection
...
class DAMeasure(StandardReadable):
    def __init__(self, name:str):
        with self.add_children_as_readables():
            ...
            self.topup = TopUpEngine(target_current=5, acceptable_loss=0.5)
